...
<i data-toggle="tooltip" data-placement="top" title="Valid Address as of {{ site.time | date_to_string }}" style="font-size:0.8em; color:" class="fa fa-check-circle fa-fw text-success"></i></p>
